<?php
    $collection = isset($w_collection) ? $w_collection: $_supplies::orderby('created_at','desc')->get();
?>
    ...
    <tbody>
        ...
        @foreach($collection as $supply)
            <tr>
                ...
                <td>
                    <strong><a href="{{route('customer.show',[$supply->order->customer->id])}}">{{$supply->order->customer->fullname()}}</a></strong>
                    <div>
        ...
        @else
            <tr>
                <td colspan="9" class="text-center">
                    <span class="grey">No supply found</span>
                </td>
            </tr>
        @endif
    </tbody>
