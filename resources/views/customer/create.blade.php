        ...
        <div class="content-box">
            ...
            <form method="POST" action="{{ route('customer.store') }}" >
                ...
                <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                    ...
                    <div class="">
                        <input id="lastname" type="text" class="form-control" name="lastname" value="{{ old('lastname') }}" placeholder="customer's last name" required autofocus>
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <div class="">
                        <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="customer's email address" required autofocus>
                        @if ($errors->has('email'))
                            <span class="help-block">
